...
int main() {
  ...
  // A line with simple formatting (va vb x \n) occupies at least 8 bytes and
  // allocates at most 2 new elements As such, the absolute maximum number of
  // nodes is size / 7.
  //  Since memory management wasn't specified, this is a simple exploit to
